<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"20px 18% 120px","margin":"30px auto","borderRadius":"0px","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","width":"100%","position":"relative"}'>
...
<style lang="scss" scoped>
	.usersView {
		...
		.usersTabView {
			...
			.usersTab:hover {
				color: #fff;
				background: radial-gradient(circle, rgba(231,208,168,1) 0%, rgba(231,214,183,1) 50%, rgba(222,202,166,1) 80%, rgba(192,171,133,1) 100%),#c0ab85;
				border-color: #c0ab85;
				border-width: 1px;
				border-style: solid;
			}
