<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"20px 18% 120px","margin":"40px auto 30px","overflow":"hidden","borderRadius":"0px","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","width":"100%","position":"relative"}'>
	...
	.news_list_six {
		...
		.six_item {
			...
			.time_box {
				...
				background: url(http://clfile.zggen.cn/20231115/b2e67337253b4ba1b20cc5b5f5cb962f.jpg) no-repeat center top;
				display: flex;
				width: 90px;
				line-height: 28px;
				justify-content: center;
