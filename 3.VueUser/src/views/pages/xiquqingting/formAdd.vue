	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 18% 60px","margin":"30px auto","borderRadius":"0px","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","width":"100%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="戏曲名称" prop="songname">
						<el-input class="list_inp" v-model="form.songname" placeholder="戏曲名称"
							 type="text" 							:readonly="!isAdd||disabledForm.songname?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="12">
					<el-form-item label="戏曲文件" prop="songfile">
						<uploads
				...
				<el-col :span="12">
					<el-form-item label="艺术家" prop="singer">
						<el-input class="list_inp" v-model="form.singer" placeholder="艺术家"
