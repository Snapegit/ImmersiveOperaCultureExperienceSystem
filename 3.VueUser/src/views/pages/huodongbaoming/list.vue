	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 18% 120px","margin":"0 auto 20px","overflow":"hidden","borderRadius":"4px","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","width":"100%","position":"relative"}'>
		...
		<el-form :inline="true" :model="searchQuery" class="list_search">
			...
			<div class="search_btn_view">
				...
				<el-button class="add_btn" type="success" v-if="btnAuth('huodongbaoming','新增')" @click="addClick">新增</el-button>
			</div>
		</el-form>
			...
			<div class="data_box">
				<div class="data_view">
					<el-table v-loading="listLoading" class="data_table" :data="list" border :row-style="{'cursor':'pointer'}"
						...
						<el-table-column label="报名编号" :resizable='true' align="left" header-align="left">
						...
						<el-table-column label="联系人姓名" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.lianxirenxingming}}
							</template>
						</el-table-column>
						...
						<el-table-column label="报名人数" :resizable='true' align="left" header-align="left">
							<template #default="scope">
								{{scope.row.renshu}}
							</template>
						</el-table-column>
...
<script setup>
	...
	const tableDetailClick = (row) => {
		router.push('huodongbaomingDetail?id=' + row.id + (centerType.value?'&&centerType=1':''))
	}
	//下载文件
	const download = (file) =>{
		if(!file){
