	...
	<div class="app-contain" :style='{"padding":"0px 18% 120px","margin":"20px auto 40px","alignItems":"flex-start","borderRadius":"0px","flexWrap":"wrap","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="info_item">
					<div class="info_label">联系人姓名</div>
					<div  class="info_text" >{{detail.lianxirenxingming}}</div>
				</div>
				<div class="info_item">
				...
				<div class="info_item">
					<div class="info_label">已报名人数</div>
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'报名')" @click="huodongbaomingonAcross('报名','huodongbaoming','','[1]','已报名')" type="warning">报名</el-button>
...
<script setup>
	...
	const huodongbaomingonAcross = (btnType,table,crossOptAudit,statusColumnName,tips,statusColumnValue) => {
		if(!context?.$toolUtil.storageGet('frontToken')){
