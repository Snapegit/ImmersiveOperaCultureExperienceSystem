...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0 18% 60px","margin":"30px auto","borderRadius":"0px","background":"url(http://clfile.zggen.cn/20231115/0bf98b23edb64e0eb248ded477134aac.jpg) no-repeat center bottom / 100% auto","width":"100%","position":"relative","height":"100%"}'>
			...
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="联系人姓名" prop="lianxirenxingming">
						<el-input class="list_inp" v-model="form.lianxirenxingming" placeholder="联系人姓名"
							 type="text" 							:readonly="!isAdd||disabledForm.lianxirenxingming?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="12">
					<el-form-item label="已报名人数" prop="renshu">
						<el-input class="list_inp" v-model.number="form.renshu" placeholder="已报名人数"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.huodongneirong = res.data.data.huodongneirong.replace(reg,'../../../cl96421320/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='lianxirenxingming'){
					form.value.lianxirenxingming = row[x];
					disabledForm.value.lianxirenxingming = true;
					continue;
				}
				if(x=='lianxifangshi'){
