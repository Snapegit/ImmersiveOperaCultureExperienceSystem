<template>
	<div class="home">
		<div class="index_top">
			<div class="index_top_title">沉浸式戏曲文化体验系统</div>
...
<style lang="scss" scoped>
	...
	.index_top {
		...
		z-index: 1002;
		color: #022c4e;
		background: url(http://clfile.zggen.cn/20231114/4229bc305a034b7a8f5751da95d76257.jpg) no-repeat center bottom;
		display: block;
		width: 100%;
	...
	.menu_view {
		...
		:deep(.first_item) {
			...
			background: url(http://clfile.zggen.cn/20231114/6621624370ec428b8e1f71e60c056959.png) no-repeat left top;
			justify-content: center;
			align-items: center;
			list-style: none;
			text-align: left;
		...
		// 选中
		:deep(.is-active) {
			color: #a07161 !important;
			background: url(http://clfile.zggen.cn/20231114/6621624370ec428b8e1f71e60c056959.png) no-repeat left top !important;
